  ...
  describe("#claim", () => {
    ...
    describe("two account tree", () => {
      ...
      it("gas", async () => {
        ...
        expect(receipt.gasUsed).to.eq(78439);
      });
    });
    describe("larger tree", () => {
      ...
      it("gas", async () => {
        ...
        const receipt = await tx.wait();
        expect(receipt.gasUsed).to.eq(80933);
      });
      ...
      it("gas second down about 15k", async () => {
        ...
        const receipt = await tx.wait();
        expect(receipt.gasUsed).to.eq(65913);
      });
    });
    ...
    describe("realistic size tree", () => {
      ...
      it("gas", async () => {
        ...
        const receipt = await tx.wait();
        expect(receipt.gasUsed).to.eq(91623);
      });
      it("gas deeper node", async () => {
        ...
        const receipt = await tx.wait();
        expect(receipt.gasUsed).to.eq(91559);
      });
